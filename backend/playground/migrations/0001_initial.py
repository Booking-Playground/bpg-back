...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('description_image', models.CharField(blank=True, max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('inventory_price', models.DecimalField(decimal_places=2, default=0, max_digits=5)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('playground_type', models.CharField(choices=[('Indoor', 'Indoor'), ('Outdoor', 'Outdoor')], max_length=10)),
                ('size', models.CharField(max_length=50)),
                ('playground_price', models.DecimalField(decimal_places=2, default=0, max_digits=7)),
                ...
                ('covering', models.ForeignKey(default=1, on_delete=django.db.models.deletion.SET_DEFAULT, related_name='playgrounds', to='playground.covering')),
            ],
            options={
